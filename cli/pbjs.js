...
exports.main = function main(args, callback) {
    ...
    var argv = minimist(args, {
        ...
        boolean: [ "create", "encode", "decode", "verify", "convert", "inspect", "delimited", "beautify", "comments", "es6", "sparse", "oneway-enums", "keep-case", "force-long", "force-number", "force-enum-string", "force-message" ],
        default: {
            target: "json",
            create: true,
            encode: true,
    ...
    if (!files.length) {
        ...
        if (callback)
            ...
            process.stderr.write([
                ...
                "  --inspect        Generate the optional inspect function for all object types.",
                "  --oneway-enums   Does not generate reverse maps for enum types (id -> string constant).",
                "",
